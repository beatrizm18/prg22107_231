...
void CampoMinado::revela_mina(QPushButton *button, int row, int col)
{
...
void CampoMinado::inicia_jogo(QWidget *parent)
{
    // Cria um layout de grade para o tabuleiro
    QGridLayout *boardLayout = new QGridLayout(parent);
...
//    QVector<QVector<QPushButton*>> board(10, QVector<QPushButton*>(10));
    ...
    for (int row = 0; row < numRows; ++row) {
        for (int col = 0; col < numCols; ++col) {
            ...
            QPushButton *cell = new QPushButton(parent);
            ...
            QObject::connect(cell, &QPushButton::clicked, [cell, this, row, col]() {
